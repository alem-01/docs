...
- 2.2.14. не выносить книги из библиотеки за пределы Школы без разрешения администрации Школы;
- 2.2.15. сопровождать приглашенных обучающимися посетителей в период их нахождения
...
- 2.2.16. в случае утери флеш-накопителя, возместить полную стоимость флеш-накопителя
  в установленный администрацией Школы срок и (или) выполнить общественные
  работы, назначенные администрацией Школы;
- 2.2.17. поддерживать порядок и чистоту на территории Школы.
